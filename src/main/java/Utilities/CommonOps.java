...
public class CommonOps extends Base {
	public static String getData(String nodeName) {
		...
		Document doc = null;
		try {
			fXmlfile = new File("A:/Automation/FinalProject/Configurations/DataConfig.xml");
	...
	public static void initDesktop()
    {
		dc.setCapability("app", getData("Calculator_App"));
            try {
                driver = new WindowsDriver(new URL(getData("Url_app")), dc);
            } catch (Exception e) {
	...
	public void StartSession(String platformName) {
		...
		managePages.init();
		manageDB.initConnection(getData("dbURL")
				, getData("dbUser"), getData("dbPassword"));
	}
